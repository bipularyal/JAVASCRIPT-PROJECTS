...
// Formatting Brush Size chnage brush size valueas it changes
...
function createCanvas() {
	...
	context.fillStyle = bucketColor; //this is bucketcolor
...
loadStorageBtn.addEventListener('click', () => {
	if (localStorage.getItem('savedCanvas')) {
		...
		restoreCanvas(); // data from localstorage painted to canvas
		// Active Tool
